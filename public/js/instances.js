...
export let MAGE_test = new CLASSES.Hero("mage","ariel mage","defense",30,["mana", 7],50 );
export let ARCHER_test = new CLASSES.Hero("archer","ariel archer","attack",40,["arrows", 6],30 );
